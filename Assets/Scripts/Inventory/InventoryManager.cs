...
public class InventoryManager : MonoBehaviour
{
    ...
    [Header("Tools")]    //Tool Slots
    [SerializeField]
    private ItemSlotData[] toolSlots = new ItemSlotData[8];    //Tool in the player's hand
    [SerializeField]
    private ItemSlotData equippedToolSlot = null; 

    [Header("Items")]    //Item Slots
    [SerializeField]
    private ItemSlotData[] itemSlots = new ItemSlotData[8];    //Item in the player's hand
    [SerializeField]
    ...
    public void InventoryToHand(int slotIndex, InventorySlot.InventoryType inventoryType){
        ...
        else if (inventoryType == InventorySlot.InventoryType.Item)
        {
            RenderHand();
        }
    ...
    public void RenderHand(){
        ...
        else if(SlotEquipped(InventorySlot.InventoryType.Item))
        {
